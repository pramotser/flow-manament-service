...
public class Constants {
    ...
    public static final class ResponseCode {
        ...
        public static final int NO_CONTENT = 204; // เซิฟเวอร์ได้ทำงานที่ต้องการเสร็จแล้ว แต่ไม่ได้มีการตอบ response
                                                  // body กลับไป
        public static final int NOT_MODIFIED = 304; // สิ่งที่ request ร้องขอไม่ได้มีการเปลี่ยนแปลง
                                                    // ทำให้ไม่มีการร้องขอข้อมูลใหม่จากเซิฟเวอร์
        public static final int BAD_REQUEST = 400;// เซิฟเวอร์ไม่เข้าใจสิ่งที่ client ร้องขอมา ซึ่งอาจเกิดจากการที่
                                                  // request ผิดรูปแบบที่ต้องการ
        public static final int UNAUTHORIZED = 401;// เกิดจากการที่ client ไม่ได้ทำ authenticate มาก่อน
                                                   // ทำให้เซิฟเวอร์ไม่สามารถให้ request นี้ทำงานได้
        public static final int FORBIDDEN = 403;// คล้ายกับ 401 แต่กรณีนี้เซิฟเวอร์รู้ว่า client เป็นใคร แต่ client
                                                // ไม่มีสิทธ์ในการเข้าถึงข้อมูลที่ต้องการ
        public static final int PAYLOAD_TOO_LARGE = 413;// เกิดจาก request ที่ client
                                                        // ส่งมามีขนาดใหญ่เกินกว่าที่เซิฟเวอร์รองรับ
        public static final int UNPROCESSABLE_ENTITY = 422;// เกิดจาก request ที่ส่งเข้ามามีรูปแบบที่ถูกต้อง
                                                           // แต่ข้อมูลที่ส่งเข้ามาไม่ถูกต้อง
                                                           // หรือไม่ครบตามความต้องการของเซิฟเวอร์
        public static final int INTERNAL_SERVER_ERROR = 500; // เกิดการทำงานที่ไม่สมบูรณ์ขึ้นที่เซิฟเวอร์
                                                             // ทำให้ไม่สามารถตอบกลับ client ตามที่ร้องขอมาได้
        public static final int SERVICE_UNAVAILABLE = 503; // ขณะนี้เซิฟเวอร์ไม่สามารถทำงานได้ชั่วคราว
                                                           // อาจเกิดจากการทำงานหนักเกินไป
                                                           // หรือกำลังอยู่ในช่วงแก้ไขระบบสามารถดูข้อมูล HTTP response
                                                           // code ทั้งหมดได้ List of HTTP status codes
    ...
    public static final class ResponseDescription {
        ...
        public static final String NO_CONTENT = "No Content"; // เซิฟเวอร์ได้ทำงานที่ต้องการเสร็จแล้ว แต่ไม่ได้มีการตอบ
                                                              // response body กลับไป
        public static final String NOT_MODIFIED = "Not Modified"; // สิ่งที่ request ร้องขอไม่ได้มีการเปลี่ยนแปลง
                                                                  // ทำให้ไม่มีการร้องขอข้อมูลใหม่จากเซิฟเวอร์
        public static final String BAD_REQUEST = "Bad Request";// เซิฟเวอร์ไม่เข้าใจสิ่งที่ client ร้องขอมา
                                                               // ซึ่งอาจเกิดจากการที่ request ผิดรูปแบบที่ต้องการ
        public static final String UNAUTHORIZED = "Unauthorized";// เกิดจากการที่ client ไม่ได้ทำ authenticate มาก่อน
                                                                 // ทำให้เซิฟเวอร์ไม่สามารถให้ request นี้ทำงานได้
        public static final String FORBIDDEN = "Forbidden";// คล้ายกับ 401 แต่กรณีนี้เซิฟเวอร์รู้ว่า client เป็นใคร แต่
                                                           // client ไม่มีสิทธ์ในการเข้าถึงข้อมูลที่ต้องการ
        public static final String PAYLOAD_TOO_LARGE = "Payload Too Large";// เกิดจาก request ที่ client
                                                                           // ส่งมามีขนาดใหญ่เกินกว่าที่เซิฟเวอร์รองรับ
        public static final String UNPROCESSABLE_ENTITY = "Unprocessable Entity";// เกิดจาก request
                                                                                 // ที่ส่งเข้ามามีรูปแบบที่ถูกต้อง
                                                                                 // แต่ข้อมูลที่ส่งเข้ามาไม่ถูกต้อง
                                                                                 // หรือไม่ครบตามความต้องการของเซิฟเวอร์
        public static final String INTERNAL_SERVER_ERROR = "Internal Server Error"; // เกิดการทำงานที่ไม่สมบูรณ์ขึ้นที่เซิฟเวอร์
                                                                                    // ทำให้ไม่สามารถตอบกลับ client
                                                                                    // ตามที่ร้องขอมาได้
        public static final String SERVICE_UNAVAILABLE = "Service Unavailable"; // ขณะนี้เซิฟเวอร์ไม่สามารถทำงานได้ชั่วคราว
                                                                                // อาจเกิดจากการทำงานหนักเกินไป
                                                                                // หรือกำลังอยู่ในช่วงแก้ไขระบบสามารถดูข้อมูล
                                                                                // HTTP response code ทั้งหมดได้ List of
                                                                                // HTTP status codes
